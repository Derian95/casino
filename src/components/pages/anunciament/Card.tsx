...
export const Card = () => {
  ...
  return (
    <div className="panel  rounded-lg h-52 w-[100vw] bg-[#2c3036] flex flex-col justify-around relative px-8 hover:bg-slate-600 group transition-all duration-200 ease-in">
